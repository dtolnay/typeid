...
fn main() {
    ...
    if compile_probe(false) {
        ...
        if compile_probe(true) {
            ...
            // This compiler does not support const TypeId in the form that the
            // current version of this crate expects. No need to pay attention
            // to RUSTC_BOOTSTRAP.
            const_type_id = false;
            consider_rustc_bootstrap = false;
        } else {
        ...
        // Without RUSTC_BOOTSTRAP, this compiler does not support const TypeId,
        // but try again if the user turns on unstable features.
        const_type_id = false;
        consider_rustc_bootstrap = true;
    }
